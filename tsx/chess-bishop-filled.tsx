function IconChessBishopFilled({
  size = 24,
  color = "currentColor",
  stroke = 2,
  ...props
  ...
  return (
    <svg
      ...
      class="icon icon-tabler icon-tabler-chess-bishop-filled"
      width={size}
      height={size}
      viewBox="0 0 24 24"
      stroke-width={stroke}
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M12 5v1" strokeWidth={0} fill="currentColor" />
      <path
...
export default IconChessBishopFilled;
