function IconKeyframeAlignVerticalFilled({
  size = 24,
  color = "currentColor",
  stroke = 2,
  ...props
  ...
  return (
    <svg
      ...
      class="icon icon-tabler icon-tabler-keyframe-align-vertical-filled"
      width={size}
      height={size}
      viewBox="0 0 24 24"
      stroke-width={stroke}
...
export default IconKeyframeAlignVerticalFilled;
